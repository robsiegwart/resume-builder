...
@click.option('--pdf', is_flag=True, default=False, help='Also export a PDF via headless Chromium (HTML themes only).')
def build(source_dir, variant, name, theme, output, palette, pdf):
